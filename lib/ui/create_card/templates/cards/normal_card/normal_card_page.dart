...
class NormalCardPage extends HookConsumerWidget {
  const NormalCardPage(this.cardState, {super.key});
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Text(cardState.informations[0], style: theme.textTheme.h30),
                    Text(cardState.informations[1], style: theme.textTheme.h30),
                  ],
                ),
                Row(
                  children: [
                      ...
                      Row(
                        children: [
                          Column(
                            ...
                            children: [
                              Text(cardState.informations[4],
                                  style: theme.textTheme.h50.bold()),
                              Text(cardState.informations[5],
